...
class TweetRepositoryAuth
{
    ...
    const TWITTER_TIMELINE_FEED_URL = "statuses/user_timeline.json?screen_name=user_name_placeholder&count=count_placeholder";
    ...
    */
    ...
    {
        return strtr(self::TWITTER_TIMELINE_FEED_URL, array('user_name_placeholder'=>$username, 'count_placeholder'=>$count));
    }
}